...
export default class FloorMap extends React.PureComponent {
    ...
    getPinPath(x, y) {
        ...
        //return `M${x} ${y}c -9.930200000000001 0 -18 8.07 -18 18 c 0 3.3600000000000003 0.9301999999999999 6.6301000000000005 2.7001 9.4501 l 14.079699999999999 23.0414 c 0.24020000000000002 0.39 0.6002 0.6301 1.0203 0.6900999999999999 c 0.5698000000000001 0.08990000000000001 1.2001 -0.15 1.53 -0.72 l 14.12 -23.2516 c 1.6797999999999997 -2.7599 2.5499 -5.9699 2.5499 -9.209999999999999 c 0 -9.93 -8.069799999999999 -18 -18 -18 z m 0 0 c -5.0398000000000005 0 -9 -4.08 -9 -9 c 0 -4.9501 4.0499 -9 9 -90s90 4.0499 9 9 c 0 4.89 -3.9000999999999997 9 -9 9 z`;
